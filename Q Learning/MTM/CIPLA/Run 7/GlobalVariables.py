...
databaseName = 'QL_CIPLA'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'cipla mtm monthly 15 15 30'
performanceOutfileNameBase = 'cipla mtm 15 15 30'
