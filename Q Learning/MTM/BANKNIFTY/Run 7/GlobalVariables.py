...
databaseName = 'QL_BANKNIFTY'                            # This is database name to which connection is made
...
logFileName = "QLearningBANKNIFTY"
...
performanceMonthlyOutfileNameBase = 'banknifty mtm monthly 15 15 30'
performanceOutfileNameBase = 'banknifty mtm 15 15 30'
