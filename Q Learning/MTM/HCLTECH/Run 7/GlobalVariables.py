...
databaseName = 'QL_HCLTECH'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'hcltech mtm monthly 15 15 30'
performanceOutfileNameBase = 'hcltech mtm 15 15 30'
