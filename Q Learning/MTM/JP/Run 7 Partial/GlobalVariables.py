...
databaseName = 'QL_JP'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'jp mtm monthly 15 15 30'
performanceOutfileNameBase = 'jp mtm 15 15 30'
