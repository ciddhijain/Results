...
alpha = [0.2, 0.8]                         # This defines the weightage to long trades as compared to short trades while constructing reward matrix
...
performanceMonthlyOutfileNameBase = 'performance monthly hindalco'
performanceOutfileNameBase = 'performance hindalco'
