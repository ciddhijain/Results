...
databaseName = 'QL_HINDALCO'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'hindalco mtm monthly 15 15 30'
performanceOutfileNameBase = 'hindalco mtm 15 15 30'
