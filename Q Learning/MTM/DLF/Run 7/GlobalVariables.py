...
databaseName = 'QL_DLF'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'dlf mtm monthly 15 15 30'
performanceOutfileNameBase = 'dlf mtm 15 15 30'
