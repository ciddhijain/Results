...
databaseName = 'QLRM_DLF'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'dlf netpl monthly 15 15 30'
performanceOutfileNameBase = 'dlf netpl 15 15 30'
