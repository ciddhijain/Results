...
databaseName = 'QLRM_BHEL'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'bhel netpl monthly 15 15 30'
performanceOutfileNameBase = 'bhel netpl 15 15 30'
