...
databaseName = 'QLRM_BANKNIFTY'                            # This is database name to which connection is made
...
logFileName = "QLearningRM_BANKNIFTY_"

maxProcesses = 2                                # This is the number of maximum processes

#-----------------------------------------------------------------------------------------------------------------------------------------
# These variables need to contain list values
alpha = [0.5, 0.6, 0.4, 0.2, 0.8]                         # This defines the weightage to long trades as compared to short trades while constructing reward matrix
...
maxGreedyLevel = [10]                 # This defines the number of future states for which reward is to be maximized in construction of q matrix
individualFactor = [12]               # This defines the factor of total asset which is to be allocated to each strategy
zeroRange = [0.006, 0.01]                   # This determines the spread between states 0, 1, 2
...
performanceMonthlyOutfileNameBase = 'banknifty netpl monthly 15 15 30'
performanceOutfileNameBase = 'banknifty netpl 15 15 30'
