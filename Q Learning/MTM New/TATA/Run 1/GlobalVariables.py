...
databaseName = 'ql_tata'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'tata mtm monthly 15 15 30'
performanceOutfileNameBase = 'tata mtm 15 15 30'
