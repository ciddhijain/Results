...
databaseName = 'ql_rcap'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'rcap mtm monthly 15 15 30'
performanceOutfileNameBase = 'rcap mtm 15 15 30'
