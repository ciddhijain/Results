...
databaseName = 'ql_rinfra'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'rinfra mtm monthly 15 15 30'
performanceOutfileNameBase = 'rinfra mtm 15 15 30'
