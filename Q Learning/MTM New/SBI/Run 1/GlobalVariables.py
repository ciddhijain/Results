...
databaseName = 'ql_sbi'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'sbi mtm monthly 15 15 30'
performanceOutfileNameBase = 'sbi mtm 15 15 30'
