...
databaseName = 'ql_rcom'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'rcom mtm monthly 30 30 30'
performanceOutfileNameBase = 'rcom mtm 30 30 30'
