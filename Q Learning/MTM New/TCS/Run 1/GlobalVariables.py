...
databaseName = 'ql_tcs'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'tcs mtm monthly 15 15 30'
performanceOutfileNameBase = 'tcs mtm 15 15 30'
