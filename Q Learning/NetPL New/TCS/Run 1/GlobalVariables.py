...
databaseName = 'qlrm_tcs'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'tcs netpl monthly 15 15 30'
performanceOutfileNameBase = 'tcs netpl 15 15 30'
