...
databaseName = 'qlrm_rcap'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'rcap netpl monthly 15 15 30'
performanceOutfileNameBase = 'rcap netpl 15 15 30'
