...
databaseName = 'qlrm_jp'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'jp netpl monthly 15 15 30'
performanceOutfileNameBase = 'jp netpl 15 15 30'
