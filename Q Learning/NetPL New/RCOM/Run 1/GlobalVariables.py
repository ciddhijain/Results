...
databaseName = 'qlrm_rcom'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'rcom netpl monthly 15 15 30'
performanceOutfileNameBase = 'rcom netpl 15 15 30'
