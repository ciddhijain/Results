...
databaseName = 'qlrm_sbi'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'sbi netpl monthly 15 15 30'
performanceOutfileNameBase = 'sbi netpl 15 15 30'
