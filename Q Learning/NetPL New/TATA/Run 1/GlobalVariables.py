...
databaseName = 'qlrm_tata'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'tata netpl monthly 15 15 30'
performanceOutfileNameBase = 'tata netpl 15 15 30'
